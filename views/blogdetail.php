...
<div id="contact-page clearfix">
    ...
    <div class="message_heading">
        <h4><span class="fa fa-comment"></span>Add my comments</h4>
        <p>(*) required</p>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <div class="form-group">
                    ...
                    <?php
                    if($isGuest) {  ?>
                        <textarea  id='content' class='form-control' placeholder='comments' rows='8'></textarea>
                    <?php } else { ?>
                        <textarea id='content' class='form-control' placeholder='comments' rows='8'></textarea>
                    <?php } ?>
                </div>
                ...
                <div class="form-group">
                    <div id="addcomment" class="btn btn-success" > Submmit </div>
                </div>
            </div>
        </div>
    </form>
